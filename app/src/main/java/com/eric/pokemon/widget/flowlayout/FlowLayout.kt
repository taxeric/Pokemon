package com.eric.pokemon.widget.flowlayout
...
import com.eric.wanandroid.base.ui.flowlayout.OnTagUpdateListener
...
class FlowLayout constructor(
    ...
    private val pxDefaultMargin = DpPxUtils.toPx(10f).toInt()
